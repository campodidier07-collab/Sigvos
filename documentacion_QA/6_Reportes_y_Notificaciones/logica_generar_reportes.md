...
Al momento de enviar los datos, el formulario en su atributo action esta conectado directamente con el controlador ReporteController.php. Dentro de este controlador, el sistema pasa por la accion o funcion llamada la función principal.
